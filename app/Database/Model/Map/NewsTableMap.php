...
class NewsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Database.Model.Map.NewsTableMap';
     ...
     */
    const OM_CLASS = '\\Database\\Model\\News';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Database.Model.News';
     ...
     */
    const COL_UNIQUE_ID = 'news.unique_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UniqueId', 'Title', 'Description', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'uniqueId', 'title', 'description', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID, NewsTableMap::COL_UNIQUE_ID, NewsTableMap::COL_TITLE, NewsTableMap::COL_DESCRIPTION, NewsTableMap::COL_CREATED_AT, NewsTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'unique_id', 'title', 'description', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UniqueId' => 1, 'Title' => 2, 'Description' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'uniqueId' => 1, 'title' => 2, 'description' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID => 0, NewsTableMap::COL_UNIQUE_ID => 1, NewsTableMap::COL_TITLE => 2, NewsTableMap::COL_DESCRIPTION => 3, NewsTableMap::COL_CREATED_AT => 4, NewsTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'unique_id' => 1, 'title' => 2, 'description' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Database\\Model\\News');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_UNIQUE_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Database\Model\News) { // it's a model object
