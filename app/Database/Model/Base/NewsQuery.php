 ...
 * @method     ChildNewsQuery orderByUniqueId($order = Criteria::ASC) Order by the unique_id column
 ...
 * @method     ChildNewsQuery groupByUniqueId() Group by the unique_id column
 ...
 * @method     ChildNews findOneByUniqueId(string $unique_id) Return the first ChildNews filtered by the unique_id column
 ...
 * @method     ChildNews requireOneByUniqueId(string $unique_id) Return the first ChildNews filtered by the unique_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildNews[]|ObjectCollection findByUniqueId(string $unique_id) Return ChildNews objects filtered by the unique_id column
...
abstract class NewsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Database\Model\Base\NewsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Database\\Model\\News', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, unique_id, title, description, created_at, updated_at FROM news WHERE id = :p0';
        try {
    ...
    public function filterByUniqueId($uniqueId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsTableMap::COL_UNIQUE_ID, $uniqueId, $comparison);
    }
