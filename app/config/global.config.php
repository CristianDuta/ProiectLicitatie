...
return array(
    "addOrEditSection" => array(
        "Title" => "Titlu",
        "EstimatedValue" => "Valoare estimata",
        "Location" => "Locatia",
        ...
        "ProfessionalAbility" => "Capacitate de exercitare a activitatii profesionale",
        "AverageTurnover" => "Cifra medie de afaceri in ultimii 3 ani",
        "CashFlow" => "Cash-flow",
        "SimilarExperience" => "Experienta similara",
